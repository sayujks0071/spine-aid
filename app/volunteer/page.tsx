...
const volunteerOpportunities = [
  {
    ...
    description: 'Help spread awareness about spinal cord injuries and our platform in your community.',
    timeCommitment: '2-4 hours/week',
  },
  {
    title: 'Donation Coordination',
    description: 'Assist in coordinating donations and helping connect donors with recipients.',
    timeCommitment: '3-5 hours/week',
  },
  {
    title: 'Content Creation',
    description: 'Create educational content, stories, and resources for our platform.',
    timeCommitment: 'Flexible',
  },
  {
    title: 'Technical Support',
    description: 'Help improve our platform and assist users with technical questions.',
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold mb-6">Volunteer with Spine Aid</h1>
          <p className="text-xl text-primary-100 max-w-3xl mx-auto">
            Join our community of volunteers making a difference in the lives of those affected by spinal cord injuries
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Your time and skills can make a real difference in connecting communities
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                See the direct impact of your efforts in helping those in need
              </p>
            </div>
            <div className="text-center">
      ...
      <section className="py-16 bg-primary-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
            Join our volunteer team and help us make a difference in the lives of those
